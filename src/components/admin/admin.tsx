...
export default function AddJob({ setResponseMessage, setErrorMessage }: AddJobProps) {
  ...
  const handleJobSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post("https://placement-portal-backend-e74c.onrender.com/api/jobs", formattedJobData)
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mb-6">
          <label className="block text-gray-700 text-sm font-semibold mb-2" htmlFor="companyUrl">
            Company Website URL
          </label>
          <input
            type="text"
