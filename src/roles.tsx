...
// Types
export type UserRole = "employee" | "student" | "alumini";
...
const roles = [
  ...
  },
  {
    ...
    title: "alumini",
    icon: Users,
    description: "Graduates and Alumini students",
    color: "bg-purple-500",
  },
  {
    id: "admin",
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
      {roles.map((role) => {
        ...
        return (
          ...
          >
            <div className={`absolute inset-0 ${role.color} opacity-10 group-hover:opacity-20 transition-opacity`} />
            <Icon className={`h-12 w-12 ${role.color} text-white rounded-lg p-2 mb-4`} />
